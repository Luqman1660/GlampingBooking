...
class Tent2 extends StatefulWidget {
  @override
  _Tent2State createState() => _Tent2State();
}

class _Tent2State extends State<Tent2> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                '- 1 Tilam Queen, 2 bantal, 1 Cadar, 1 Selimut, Plug, Kipas, 2 Kerusi, 1 Meja, Lampu, Lampu hiasan, 1 Alas Kaki, 1 Karpet',
