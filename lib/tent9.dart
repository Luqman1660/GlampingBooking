...
class Tent9 extends StatefulWidget {
  @override
  _Tent9State createState() => _Tent9State();
}

class _Tent9State extends State<Tent9> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'The Bazoongi tent delivers ample space and robust build quality, making it an outstanding choice for your outdoor escapades.',
            ...
            Padding(
              ...
              child: Text(
                ' 4 - 8 Pax', // Add the '4 - 8 Pax' text here
                style: TextStyle(fontSize: 16),
                textAlign: TextAlign.center,
              ),
            ),
